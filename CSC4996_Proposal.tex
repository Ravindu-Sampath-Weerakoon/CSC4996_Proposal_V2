...
% --- Tables (CRITICAL) ---
\usepackage[table]{xcolor} % <--- Must be loaded BEFORE booktabs
...
\usepackage[hidelinks]{hyperref}    % Interactive links (Load last generally)
...
% --- C. Section Font Sizes (16pt/14pt) ---
\titleformat{\section}
...
% --- D. Custom Numbering (1.0, 2.0) ---
\renewcommand{\thesection}{\arabic{section}.0}
\renewcommand{\thesubsection}{\arabic{section}.\arabic{subsection}}

% --- E. List of Equations Setup ---
...
% --- F. Bibliography Resource ---
\addbibresource{references.bib}

% --- G. Fixes ---
% Fix for "Infinite glue shrinkage" warning in longtables
\raggedbottom 
